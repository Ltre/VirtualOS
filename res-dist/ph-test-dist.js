...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports) {
	    ...
	    function Ph() {
	        ...
	        var _bindProxyInIE = function _bindProxyInIE() {
	            var createActiveXAgent = function createActiveXAgent(ao) {
	                var agent = new Object();
	                agent.activeXObject = ao; //被包裹的内核，是真正的通信对象
	                agent.syncAttribute = function () {
	                    //syncAttribute是用来同步属性的	
	                    try {
	            ...
	            ActiveXObject = function ActiveXObject(param) {
	        ...
	        var _bindProxyNotIE = function _bindProxyNotIE() {
	        ...
	        var _bindProxy = function _bindProxy() {
	        ...
	        var _urlNeedPack = function _urlNeedPack(url) {
	        ...
	        return {
	            tool: {
	                getProxyUrl: function getProxyUrl(url, data, dataType, method) {
	                    var pack = {
	                        url: url,
	                        data: data || {},
